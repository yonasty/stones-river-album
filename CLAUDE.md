...
## Versioning
- `VERSION` file in repo root, currently **`2.16.0`**.
...
## Current State (as of 2026-08-17, v2.16.0)
...
- **Eric Jacobsen bio (v2.16.0):** the sentence about The Knights / NYC-based chamber orchestra was cut at Ben's request. Note the separate "(The Knights, Brooklyn Rider)" credit in `FullBioSection.tsx` was intentionally left in place — different sentence, different section.
