...
export const preorderProducts: ProductConfig[] = [
  ...
  },
  {
    ...
    includedItems: [
      { name: 'Museum-quality archival art print, hand-numbered and signed by Rush Baker IV', quantity: 1, image: '/assets/Individual Item Images/Museum Print - Signed Print.jpg', modalImages: ['/assets/Individual Item Images/Museum Print - Signed Print.jpg', '/assets/Individual Item Images/Museum Print - Rush Baker Signing 1.jpg', '/assets/Individual Item Images/Museum Print - Rush Baker Signing 2.jpg'] },
      { name: 'Limited-edition signed blue vinyl of Stones River in deluxe packaging (only 200 pressed)', quantity: 1, image: '/assets/Individual Item Images/Blue Vinyl.png', modalImages: ['/assets/Individual Item Images/Blue Vinyl.png', '/assets/Individual Item Images/Blue Vinyl - Grouping.jpg', '/assets/Individual Item Images/Blue Vinyl - Cover and Disc.jpg'] },
      { name: 'Signed CD of Stones River with deluxe artwork', quantity: 1, image: '/assets/Individual Item Images/Signed CD.png', modalImages: ['/assets/Individual Item Images/Signed CD.png', '/assets/Individual Item Images/Signed CD - Grouping.jpg', '/assets/Individual Item Images/Signed CD - Disc.png', '/assets/Individual Item Images/Signed CD - Back.jpg', '/assets/Individual Item Images/Signed CD - Inside.jpg', '/assets/Individual Item Images/Signed CD - Insert.jpg'] },
      { name: 'Exclusive group listening session and Q&A with Jeremy discussing the piece\u2019s story, composition, and recording process', quantity: 1, image: '/assets/Individual Item Images/Jeremy_Kittel.jpg' },
      { name: 'Instant access to 2 unreleased tracks from the album', quantity: 1, image: '/assets/Individual Item Images/Access to 2 unreleased tracks.png' },
      { name: 'Early access to exclusive live performance video', quantity: 1, image: '/assets/Individual Item Images/Exclusive live performance.jpeg' },
