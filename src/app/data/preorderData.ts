...
export const preorderProducts: ProductConfig[] = [
  ...
  },
  {
    ...
    includedItems: [
      ...
      { name: 'Instant access to 2 unreleased tracks from the album', quantity: 1, image: '/assets/Individual Item Images/Access to 2 unreleased tracks.png' },
      { name: 'Early access to exclusive live performance video', quantity: 1, image: '/assets/Individual Item Images/Exclusive live performance.jpeg' },
      { name: 'Early access to interview footage with Jody Elff, Eric Jacobsen, & Jeremy Kittel', quantity: 1, image: '/assets/Individual Item Images/Interview Footage Early Access (cropped).png', modalImages: ['/assets/Individual Item Images/Interview Footage Early Access (Eric).png', '/assets/Individual Item Images/Interview Footage Early Access (Modal).png'] },
    ],
