...
export const preorderProducts: ProductConfig[] = [
  ...
  },
  {
    ...
    tierDescription: 'This is the pinnacle of support, designed for the maximum benefactor who deserves the rarest and most personal items. The Associate Producer tier is limited to just 10 patrons. You receive an exclusive, signed test pressing (only 10 made), a personal handwritten letter from Jeremy, and your name listed on the album website.',
