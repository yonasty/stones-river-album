...
export const preorderProducts: ProductConfig[] = [
  {
    ...
    tierIncludes: [
      ...
      'Instant access to two tracks from the album',
      'Early access to exclusive live performance video',
    ],
    includedItems: [
      { name: 'Signed CD of Stones River with deluxe artwork', quantity: 1, image: '/assets/Individual Item Images/Signed CD.png', modalImages: ['/assets/Individual Item Images/Signed CD.png', '/assets/Individual Item Images/Signed CD - Grouping.jpg', '/assets/Individual Item Images/Signed CD - Disc.png', '/assets/Individual Item Images/Signed CD - Back.jpg', '/assets/Individual Item Images/Signed CD - Inside.jpg', '/assets/Individual Item Images/Signed CD - Insert.jpg'] },
      { name: 'Instant access to two tracks from the album', quantity: 1, image: '/assets/Individual Item Images/Access to 2 unreleased tracks.png' },
  ...
  },
  {
    ...
    includedItems: [
      { name: 'Signed black vinyl of Stones River in deluxe packaging', quantity: 1, image: '/assets/Individual Item Images/Black Vinyl Cover.png', modalImages: ['/assets/Individual Item Images/Black Vinyl Cover.png', '/assets/Individual Item Images/Black Vinyl - Side B.png', '/assets/Individual Item Images/Black Vinyl - Deluxe Packaging.png', '/assets/Individual Item Images/Black Vinyl - Grouping B.jpg', '/assets/Individual Item Images/Black Vinyl - Grouping A.jpg', '/assets/Individual Item Images/Black Vinyl - Grouping D.jpg', '/assets/Individual Item Images/Black Vinyl - C2.jpg', '/assets/Individual Item Images/Black Vinyl - C3.jpg', '/assets/Individual Item Images/Black Vinyl - Back.jpg'] },
      { name: 'Instant access to two tracks from the album', quantity: 1, image: '/assets/Individual Item Images/Access to 2 unreleased tracks.png' },
      { name: 'Early access to exclusive live performance video', quantity: 1, image: '/assets/Individual Item Images/Exclusive live performance.jpeg' },
    ],
  ...
  },
  {
    ...
    cardDescription: 'Digital orchestral score, limited-edition blue vinyl (only 200 pressed), signed CD, listening session, and early access content.',
    tierIncludes: [
    ...
    includedItems: [
      ...
      { name: 'Limited-edition signed blue vinyl of Stones River in deluxe packaging (only 200 pressed)', quantity: 1, image: '/assets/Individual Item Images/Blue Vinyl.png', modalImages: ['/assets/Individual Item Images/Blue Vinyl.png', '/assets/Individual Item Images/Blue Vinyl - Grouping.jpg', '/assets/Individual Item Images/Blue Vinyl - Cover and Disc.jpg', '/assets/Individual Item Images/Black Vinyl - Back.jpg'] },
      { name: 'Signed CD of Stones River with deluxe artwork', quantity: 1, image: '/assets/Individual Item Images/Signed CD.png', modalImages: ['/assets/Individual Item Images/Signed CD.png', '/assets/Individual Item Images/Signed CD - Grouping.jpg', '/assets/Individual Item Images/Signed CD - Disc.png', '/assets/Individual Item Images/Signed CD - Back.jpg', '/assets/Individual Item Images/Signed CD - Inside.jpg', '/assets/Individual Item Images/Signed CD - Insert.jpg'] },
      { name: 'Exclusive group listening session and Q&A with Jeremy discussing the piece\u2019s story, composition, and recording process', quantity: 1, image: '/assets/Individual Item Images/Jeremy_Kittel.jpg' },
      { name: 'Instant access to two tracks from the album', quantity: 1, image: '/assets/Individual Item Images/Access to 2 unreleased tracks.png' },
      { name: 'Early access to exclusive live performance video', quantity: 1, image: '/assets/Individual Item Images/Exclusive live performance.jpeg' },
    ...
    tierDescription: "Join the Composer's Circle—the perfect tier for the musician, composer, or serious music student who wants to delve into the technical brilliance of Stones River. This bundle pairs the full digital orchestral score with the extremely limited-edition signed blue vinyl (only 200 pressed).",
    fallbackTitle: "Tier 4 — Composer's Circle",
  ...
  },
  {
    ...
    cardDescription: 'Museum-quality signed art print, digital orchestral score, limited-edition blue vinyl, signed CD, listening session, and early access content.',
    tierIncludes: [
    ...
    includedItems: [
      { name: 'Museum-quality archival art print, hand-numbered and signed by Rush Baker IV', quantity: 1, image: '/assets/Individual Item Images/Museum Print - Signed Print.jpg', modalImages: ['/assets/Individual Item Images/Museum Print - Signed Print.jpg', '/assets/Individual Item Images/Museum Print - Rush Baker Signing 1.jpg', '/assets/Individual Item Images/Museum Print - Rush Baker Signing 2.jpg'] },
      { name: 'Digital orchestral score of Stones River', quantity: 1, image: '/assets/Individual Item Images/Jeremy_Kittel.jpg' },
      { name: 'Limited-edition signed blue vinyl of Stones River in deluxe packaging (only 200 pressed)', quantity: 1, image: '/assets/Individual Item Images/Blue Vinyl.png', modalImages: ['/assets/Individual Item Images/Blue Vinyl.png', '/assets/Individual Item Images/Blue Vinyl - Grouping.jpg', '/assets/Individual Item Images/Blue Vinyl - Cover and Disc.jpg', '/assets/Individual Item Images/Black Vinyl - Back.jpg'] },
      { name: 'Signed CD of Stones River with deluxe artwork', quantity: 1, image: '/assets/Individual Item Images/Signed CD.png', modalImages: ['/assets/Individual Item Images/Signed CD.png', '/assets/Individual Item Images/Signed CD - Grouping.jpg', '/assets/Individual Item Images/Signed CD - Disc.png', '/assets/Individual Item Images/Signed CD - Back.jpg', '/assets/Individual Item Images/Signed CD - Inside.jpg', '/assets/Individual Item Images/Signed CD - Insert.jpg'] },
      { name: 'Exclusive group listening session and Q&A with Jeremy discussing the piece\u2019s story, composition, and recording process', quantity: 1, image: '/assets/Individual Item Images/Jeremy_Kittel.jpg' },
    ...
    tierDescription: 'Ideal for fans who value visual art and music equally. This tier centers on the museum-quality archival art print, hand-numbered and signed by Rush Baker IV, alongside the full digital orchestral score, the limited-edition signed blue vinyl (only 200 pressed), and the complete media collection.',
    fallbackTitle: 'Tier 5 — Gallery Patron',
  ...
  },
  {
    ...
    tierDescription: 'This is the pinnacle of support, designed for the maximum benefactor who deserves the rarest and most personal items. The Associate Producer tier is limited to just 10 patrons. You receive an exclusive, signed test pressing (only 10 made), a personal handwritten letter from Jeremy, and acknowledgement as an associate producer on the website.',
    fallbackTitle: 'Tier 6 — Associate Producer',
