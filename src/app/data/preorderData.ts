...
export const preorderProducts: ProductConfig[] = [
  {
    ...
    includedItems: [
      { name: 'Signed CD of Stones River with deluxe artwork', quantity: 1, image: '/assets/Individual Item Images/Signed CD.png', modalImages: ['/assets/Individual Item Images/Signed CD.png', '/assets/Individual Item Images/Signed CD - Grouping.jpg', '/assets/Individual Item Images/Signed CD - Disc.png'] },
  ...
  },
  {
    ...
    includedItems: [
      { name: 'Signed black vinyl of Stones River in deluxe packaging', quantity: 1, image: '/assets/Individual Item Images/Black Vinyl Cover.png', modalImages: ['/assets/Individual Item Images/Black Vinyl Cover.png', '/assets/Individual Item Images/Black Vinyl - Side B.png', '/assets/Individual Item Images/Black Vinyl - Deluxe Packaging.png', '/assets/Individual Item Images/Black Vinyl - Grouping B.jpg', '/assets/Individual Item Images/Black Vinyl - Grouping A.jpg', '/assets/Individual Item Images/Black Vinyl - Grouping D.jpg'] },
      { name: 'Instant access to 2 unreleased tracks from the album', quantity: 1, image: '/assets/Individual Item Images/Access to 2 unreleased tracks.png' },
      { name: 'Early access to exclusive live performance video', quantity: 1, image: '/assets/Individual Item Images/Exclusive live performance.jpeg' },
    ],
